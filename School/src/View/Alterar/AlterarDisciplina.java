 ...
 * @author adria
 */
public class AlterarDisciplina extends javax.swing.JInternalFrame {
     ...
     */
    private AlterarDisciplina() {
        initComponents();
    }

    public AlterarDisciplina(int id, String nomeatual) {
        initComponents();
        TFDisciplina.setText(nomeatual);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alterar Disciplinas");
        ...
        jPanel2.setBounds(-10, 90, 630, 220);
        ...
        if (TFDisciplina.getText().matches("[0-9]+") || TFDisciplina.getText().matches("[!@#$%¨&*]")) {
            ...
            if (TFDisciplina.getText().equals("")) {
                ...
                if (b.isEmpty()) {
                    ...
                    alterarDisciplinaNoBanco(b);
                }
            }
        }
        Principal.getConsultaDisciplinaInstance().ListaTable();
    }//GEN-LAST:event_SalvarActionPerformed
    private void alterarDisciplinaNoBanco(String a) {
        DisciplinaDAO discDAO = new DisciplinaDAO();
        discDAO.AtualizarDisciplina(id, a);
        TFDisciplina.setText("");
        this.dispose();
